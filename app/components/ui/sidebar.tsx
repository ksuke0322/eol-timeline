...
function SidebarProvider({
  ...
  // これはサイドバーの内部状態です。
  // コンポーネントの外部から制御するためにopenPropとsetOpenPropを使用します。
  ...
  // サイドバーを切り替えるためのキーボードショートカットを追加します。
  React.useEffect(() => {
  ...
  // data-state="expanded" または "collapsed" を設定できるように状態を追加します。
  // これにより、Tailwindクラスでサイドバーをスタイリングしやすくなります。
